...
To download the latest version of the dedicated server to your machine:
	...
	f) Half-Life mods (eg cstrike, dod) and Source mods (eg hl2mp) must be installed to separate directories
...
To see this info and info about other options of the tool, run it with "-?" and it will print them on the screen.
